...
public class GameManager : MonoBehaviour
{
    ...
    public void FruitEaten(Fruit Fruits)
    {
        Fruits.gameObject.SetActive(false);

        SetScore(score + Fruits.points);
    }
    ...
    private void FreezeAllObjects()
    {
        ...
        pacman.GetComponent<Rigidbody2D>().isKinematic = true;

        foreach (Transform pellet in pellets)
        {
            pellet.GetComponent<Rigidbody2D>().isKinematic = true;
        }
    }
